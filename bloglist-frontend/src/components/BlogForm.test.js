...
describe('BlogForm', () => {
  ...
  beforeEach(() => {
    container = render(<BlogForm sendBlog={mockHandleSendBlog} showNotification={mockHandleShowNotification} />).container
  })
  ...
  test('clicking add blog button, the sendBlog function is called once with correct data', async () => {
    ...
    expect(mockHandleSendBlog.mock.calls[0][0]).toEqual({ title:title, author:author, url:url })
